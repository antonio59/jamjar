    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md transition-colors"
        >
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-3xl font-bold dark:text-gray-200">
              {data.rejected + data.failed}
            </span>
          </div>
          <p className="text-gray-600 dark:text-gray-400">Rejected/Failed</p>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-bold dark:text-gray-200">By Profile</h2>
          </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${(data.byProfile.yoto / data.total) * 100}%`,
                  }}
                />
              </div>
            </div>
            <div>
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${(data.byProfile.ipod / data.total) * 100}%`,
                  }}
                />
              </div>
            </div>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-bold dark:text-gray-200">By Type</h2>
          </div>
          <div className="space-y-3">
            <div>
              <div className="flex justify-between mb-1">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${(data.byType.music / data.total) * 100}%`,
                  }}
                />
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-700 dark:text-gray-300 flex items-center gap-2">
                  <Book className="w-4 h-4" /> Audiobook
                </span>
                <span className="font-bold dark:text-gray-200">
                  {data.byType.audiobook}
                </span>
              </div>
              <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${(data.byType.audiobook / data.total) * 100}%`,
                  }}
                />
              </div>
            </div>
      ...
      {data.topRequested.length > 0 && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md mb-8 transition-colors"
        >
